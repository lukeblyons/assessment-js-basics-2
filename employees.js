...
//CODE HERE
const empOne = new Employee('Luke Lyons', 'Monday, Wednesday and Friday')
...
class Manager extends Employee {
    ...
    getEmployees(){
        ...
        console.log(`${this.name} manages ${employeeList}`);
    }
    addEmployee(emp){
...
//CODE HERE
const cece = new Employee('Cece', 'weekday mornings');
const schmidt = new Employee('Schmidt', 'weekday afternoons');
...
//CODE HERE 
const coach = new Employee('Coach', 'weekends');
